...
[![Maven Central](https://img.shields.io/maven-central/v/io.github.easy4j/simplecaptcha-spring-boot-starter)](https://github.com/easy-4-java/simplecaptcha-spring-boot-starter)
...
> **Artifact ID**：`simplecaptcha-spring-boot-starter`<br>
> **License**：Apache License 2.0<br>

## 1. Positioning

**simplecaptcha-spring-boot-starter** is a Spring Boot starter that integrates **simplecaptcha** for applications using simplecaptcha. It provides auto-configuration, property binding, and ready-to-use beans so that applications can consume simplecaptcha capabilities with minimal setup.

| Dimension | Description |
|---|---|
| Type | Spring Boot Starter |
| Consumers | Spring Boot applications using simplecaptcha |
| Core Capabilities | auto-configuration, property binding, ready-to-use beans for simplecaptcha |
| JDK | `17` |
| Coordinates | `io.github.easy4j:simplecaptcha-spring-boot-starter:3.3.x.20260527-SNAPSHOT` |
| Config Prefix | `simplecaptcha` |

## 2. Core Capabilities

| Capability | Status | Description |
|---|:---:|---|
| Auto-configuration | ✅ Stable | Registers simplecaptcha beans automatically |
| Property Binding | ✅ Stable | Binds `simplecaptcha.*` to `SimpleCaptchaProperties` |
| Ready-to-use beans | ✅ Stable | Auto-registered via SimpleCaptchaAutoConfiguration |
...
|---|---|---|:---:|---|:---:|
| `simplecaptcha.enabled` | boolean | `true` | No | Enable the starter | No |
...
```bash
mvn clean verify
mvn -pl simplecaptcha-spring-boot-starter -am test
```
...
|---|---|---|
| Bean not created | Check auto-configuration report | Verify `simplecaptcha.enabled=true` and classpath |
...
[Back to top](#readme-top) · [Issues](https://github.com/easy-4-java/simplecaptcha-spring-boot-starter/issues) · [Repository](https://github.com/easy-4-java/simplecaptcha-spring-boot-starter)
